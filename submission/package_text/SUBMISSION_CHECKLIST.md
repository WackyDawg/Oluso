...
Do not describe the synthetic evaluation as deployed bank performance. In the live pitch, state the disclosed weaknesses: 0/3 low-and-slow recall and 3/4 remote-control USSD recall at the main threshold; 83.33% recall on unseen accounts; a patient same-device/SIM adaptive evasion without graph or precursor context; and the need for field calibration, agent appeal governance, HSM-backed institutional keys, formal consortium rules and a production privacy protocol for the fraud-sketch exchange.
